...
export default class QueryBuilder extends LightningElement {
    ...
    */
    ...
    // WHERE Clause
    /**
     * @description : list of operators used in making where clause
     */
    get operators(){
        return [
            { label: 'Equals', value: ' =' },
    ...
    // order by
    /**
     * @description : this is called everytime a field is selected in order by Combobox and adds value to orderby
     */
    handleOrderBy(event){
    ...
    // Group By
    /**
     * @description : it is called everytime some value if selected in group by combobox
     */
     aggrFunc='';
     aggrField='';
     groupingField='';
    ...
    handleAggrFire(event){
        try {
            ...
            /*
            makeAggregateQuery({ query : finalQuery  })
                .then(result => {
                    this.aggrResult=result;
                    for( let item of this.aggrResult){
                        console.log('=>'+item.field+' : '+item.expr);
                    }    
                    console.log('this.aggrResult'+this.aggrResult);
                })
                .catch(error => {
                    this.dispatchEvent(new ShowToastEvent({
                        title: 'Some Problem Occured , Please Try Again Later.',
    ...
    //LIMIT
    /**
     * @description : this is called everytime some value is entered in Max Records Input box and stores entered value to totalNumberOfRows
     */
    ...
    //Data Table Sorting
    /**
     *@description : this method will help the onHandleSort method in sorting values 
    */
